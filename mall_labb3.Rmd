...
Den skillnad som uppstår då man utvärderar felen på de olika datamängderna består i att felet blir betydligt lägre då man predikterar utifrån perioden 1970-2007 eftersom det förekommer mer visshet då prediktionsintervallet är baserat på befintlig data till skillnad från obefintlig data där det kan förekomma mer slumpmässighet och osäkerhet. 
...
plot(df_test$år,df_test$temperatur,xlab = 'År',ylab = 'Förväntad temperatur',ylim = c(-0.5,1))
