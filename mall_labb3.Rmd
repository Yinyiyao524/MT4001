...
Vi kan utifrån denna sluta oss till att regression verkar inte verkar vara en lämplig prediktionsmodell för vår data eftersom det förekommer flera outliers som är utanför prediktionsintervallet vilket ger en viss osäkerhet i vår prediktion. Utifrån observationerna i vårt diagram kan vi dra slutsatsen att modellen skulle kunna förbättras om den delades in i mindre intervall som fångar variationerna och trenderna bättre. Ett problem med att prediktera framtida temperaturer på detta sätt är att det kan förekomma osäkerhet som vi ser i vårt diagram finns det flera outliers i prediktionsintervallet som gör det svårt att kunna prediktera temperaturen med någorlunda precision.
