...
```{r}
data <- read.csv(("C:/Users/User-Dator/Documents/MT4001/olvinsprit.csv"), header = TRUE)
land <- data$Land
beer <- data$beer
vin <- data$vin
sprit <- data$sprit
...
Det verkar finnas ett negativt samband mellan vinkonsumtion och spritkonsumtion. Länder som Japan har mycket hög spritkonsumtion men dricker lite vin. På samma sätt har länderna som dricker mycket vin en låg spritkonsumtion.
