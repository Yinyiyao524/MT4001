...
```{r, fig.cap= 'Normalfördelning n=10' }
...
```{r, fig.cap= 'Normalfördelning n=10 par' }
...
```{r, fig.cap= 'Normalfördelning n=20' }
...
```{r, fig.cap= 'Normalfördelning n=20 par' }
old_par <- par(mfrow = c(2, 4)) # 2 rader, 4 kolonner
hist(x20_1)
hist(x20_2)
hist(x20_3)
...
```{r, fig.cap= 'Normalfördelning n=50 par' }
old_par <- par(mfrow = c(2, 4)) # 2 rader, 4 kolonner
hist(x50_1)
hist(x50_2)
hist(x50_3)
...
```{r, fig.cap= 'Normalfördelning n=100' }
...
```{r, fig.cap= 'Normalfördelning n=100 par' }
old_par <- par(mfrow = c(2, 4)) # 2 rader, 4 kolonner
hist(x100_1)
hist(x100_2)
hist(x100_3)
