...
```{r}
wilcox.test(seed1, nonseed1, alternative = "greater", paired = FALSE, conf.level = 0.95,mu = 0, exact = FALSE) 
```

Vi kan här se att $\alpha < p$ så vi kan ej förkasta nollhypotesen

```{r}
wilcox.test(seed2, nonseed2, alternative = "greater", paired = FALSE, conf.level = 0.95,mu = 0, exact = FALSE)
```
