...
```{r}
wilcox.test(seed1, nonseed1, alternative = "greater") # två grupper har olika mängd, därför är de oberoende (paired=FALSE)
wilcox.test(seed2, nonseed2, alternative = "greater")
```
