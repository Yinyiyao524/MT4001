...
vår datamängd avviker från normalfördelningen. Vi fortsätter med ett histogram över
...
tenderar att vara kring 0 och ingen klockform visar sig. Vi fortsätter med histogram över nederbörd
utan molnsådd
...
utföra Wilcoxons teckentangtest. Om differensen visar sig vara normalfördelad
...
```{r,fig.cap='Figur 7: Q-Q-plot: Med molnsådd i område 1'}
...
```{r,fig.cap='Figur 8: Q-Q-plot: Utan molnsådd i område 1'}
...
```{r,fig.cap='Figur 9: Q-Q-plot: Med molnsådd i område 2'}
...
```{r,fig.cap='Figur 10: Q-Q-plot: Utan molnsådd i område 2'}
...
```{r,fig.cap='Figur 11: Histogram: Utan molnsådd i område 1'}
...
```{r,fig.cap='Figur 12: Histogram: Med molnsådd i område 1'}
...
```{r,fig.cap='Figur 13: Histogram: Utan molnsådd i område 2'}
...
```{r,fig.cap='Figur 14: Histogram: Med molnsådd i område 2'}
...
```{r,fig.cap='Figur 15: Boxplot: Utan molnsådd i område 1'}
...
```{r,fig.cap='Figur 16: Boxplot: Med molnsådd i område 1'}
...
```{r,fig.cap='Figur 17: Boxplot: Utan molnsådd i område 2'}
...
```{r,fig.cap='Figur 18: Boxplot: Med molnsådd i område 2'}
